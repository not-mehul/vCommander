...
class VerkadaInternalAPIClient:
    ...
    def _fetch_list(
        ...
        *,
        ...
        filter_func, when given, is applied to each raw item before
        mapping — used to partition a shared endpoint (e.g. access
        controllers vs. Access Station Pros, distinguished by model id).
        """
